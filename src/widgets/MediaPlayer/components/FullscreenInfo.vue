...
const {currentAudioData} = storeToRefs(currentStore);

</script>

<template>
  <div v-if="currentPlaylistInfo && currentAudioData" class="info">
    <div class="playlist-info">
      ...
      <div class="metadata">
        <div class="header">PLAYING FROM {{(currentPlaylistInfo!.type).toUpperCase()}}</div>
        <div class="name">{{currentPlaylistInfo.name}}</div>
      </div>
    </div>
