...
defineProps<{
  ...
  currentPlaybackType: 'album' | 'playlist'
  currentPlaybackName: string
  currentTrackImage: string
  currentTrackName: string
  currentTrackArtists: SimplifiedArtist[]
